...
{
    class SmokeParticles : DefaultTexturedQuadParticleSystem
    {
        ...
        public SmokeParticles(Game cGame) : base(cGame) { }
        ...
        public void LoadParticleSystem()
        {
            ...
            InitialProperties.VelocityMin = new Vector3(2, -0.1f, 1);
            InitialProperties.VelocityMax = new Vector3(-1, 0.5f, -10);
        ...
        //destroys the particle of goes out of bounds
        public void UpdateMovement(Vector3 p)
        {
            Vector3 position = Emitter.PositionData.Position;
            Emitter.PositionData.Position += p;
            if (position.X >200f||
                position.X < -200f ||
                position.Z > 200f ||
                position.Z < -200f)
        ...
        //resets the particles position
        public void ResetPos(Vector3 z)
        {
            
                Emitter.PositionData.Position = z;
